            ...
            <ul className="space-y-4 text-sm text-brand-footer-text/70">
              ...
              <li className="flex flex-col space-y-1.5">
                <div className="flex items-center space-x-3">
                  ...
                  <a 
                    href="tel:+919709143253" 
                    className="hover:text-brand-primary transition-colors font-semibold text-white text-base"
                    aria-label="Call MakeMyPages at +91 9709143253"
                  >
                    +91 9709143253
                  </a>
                </div>
                <div className="pl-7 text-xs text-slate-400 flex items-center gap-2">
                  <a href="tel:+919709143253" className="text-brand-primary hover:underline font-medium">Click to Call</a>
                  <span>•</span>
                  <a href="https://wa.me/919709143253" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:underline font-medium">WhatsApp Chat</a>
                </div>
              </li>
              <li className="flex items-center space-x-3">
