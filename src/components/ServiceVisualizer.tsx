    ...
    <div className="relative w-full aspect-[4/3] bg-brand-bg rounded-[2.5rem] border border-brand-border p-6 flex flex-col justify-between overflow-hidden shadow-2xl">
      ...
      <div className="flex-1 flex flex-col justify-center py-4 z-10 relative">
        <AnimatePresence mode="wait">
          ...
          {/* INFLUENCER MARKETING CREATOR VISUALIZER */}
          {slug === 'influencer-marketing' && (
            <motion.div 
              ...
              className="space-y-3"
            >
              <div className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden shadow-xl group relative">
                <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-950">
                  ...
                  {/* Creator Overlay Badge HUD */}
                  <div className="absolute inset-3 flex flex-col justify-between p-1">
                    <div className="flex justify-between items-center bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/15 text-white">
                      <div className="flex items-center gap-2">
                        <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping"></span>
                        <span className="text-[11px] font-mono font-extrabold text-white uppercase tracking-wider">
                          VERIFIED CREATOR CAMPAIGN
                        </span>
                      </div>
                      <span className="text-[10px] font-extrabold text-white bg-gradient-to-r from-pink-500 to-purple-600 px-2.5 py-0.5 rounded-full shadow-sm">
                        250K+ REACH
                      </span>
                    </div>

                    <div className="bg-black/80 backdrop-blur-lg p-3 rounded-2xl border border-white/20 text-white flex justify-between items-center shadow-2xl">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="text-xs font-bold text-white leading-tight flex items-center gap-1">
                            <span>@MakeMyPages.Creators</span>
                            <span className="text-sky-400 font-bold text-[10px]">✓</span>
                          </h4>
                          <span className="text-[9.5px] text-slate-300">Nano, Micro & Macro Campaign Integration</span>
                        </div>
                      </div>

                      {/* Interactive Creator Engagement */}
                      <div className="flex items-center gap-2 bg-white/10 px-2.5 py-1.5 rounded-xl border border-white/15">
                        <button 
                          onClick={() => triggerReaction('likes')}
                          className="flex items-center gap-1 text-pink-400 hover:scale-110 transition-transform cursor-pointer text-xs font-bold"
                        >
                        ...
                        <button 
                          ...
                          className="flex items-center gap-1 text-purple-300 hover:scale-110 transition-transform cursor-pointer text-xs font-bold"
                        >
                          <Share2 size={14} />
          ...
          {/* GOOGLE ADS MANAGEMENT VISUALIZER */}
          {slug === 'google-ads-management' && (
            <motion.div 
              ...
              className="space-y-3"
            >
              <div className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden shadow-xl p-4 text-white space-y-3">
                <div className="flex justify-between items-center border-b border-slate-800 pb-2.5">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping"></span>
                    <span className="text-xs font-mono font-bold text-slate-200">GOOGLE ADS LIVE METRICS</span>
                  </div>
                  <span className="text-[10px] bg-sky-500/20 text-sky-400 px-2.5 py-0.5 rounded-full border border-sky-500/30 font-bold">
                    HIGH INTENT PPC
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-slate-950/80 p-2.5 rounded-xl border border-slate-800">
                    <span className="text-[10px] text-slate-400 block mb-0.5">Impressions</span>
                    <span className="text-sm font-extrabold text-white">48,290</span>
                    <span className="text-[9px] text-emerald-400 block mt-0.5">↑ +24% YoY</span>
                  </div>
                  <div className="bg-slate-950/80 p-2.5 rounded-xl border border-slate-800">
                    <span className="text-[10px] text-slate-400 block mb-0.5">Avg CTR</span>
                    <span className="text-sm font-extrabold text-sky-400">8.42%</span>
                    <span className="text-[9px] text-emerald-400 block mt-0.5">3.2x Industry</span>
                  </div>
                  <div className="bg-slate-950/80 p-2.5 rounded-xl border border-slate-800">
                    <span className="text-[10px] text-slate-400 block mb-0.5">Conversions</span>
                    <span className="text-sm font-extrabold text-emerald-400">342</span>
                    <span className="text-[9px] text-emerald-400 block mt-0.5">CPA -38%</span>
                  </div>
                </div>

                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 flex items-center justify-between">
                  <div className="space-y-0.5">
                    <span className="text-[10px] text-slate-400 block">Top Keyword Bid</span>
                    <span className="text-xs font-bold text-slate-200">"best website developers near me"</span>
                  </div>
          ...
          {/* META ADS MANAGEMENT VISUALIZER */}
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden shadow-xl p-4 text-white space-y-3">
                <div className="flex justify-between items-center border-b border-slate-800 pb-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono font-bold text-slate-200">META ADS MANAGER</span>
                  </div>
                  <span className="text-[10px] bg-gradient-to-r from-pink-500 to-purple-600 text-white px-2.5 py-0.5 rounded-full font-bold">
                    ROAS 4.8X
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-slate-950/80 p-2.5 rounded-xl border border-slate-800">
                    <span className="text-[10px] text-slate-400 block mb-0.5">Ad Reach</span>
                    <span className="text-sm font-extrabold text-white">124.5K</span>
                    <span className="text-[9px] text-pink-400 block mt-0.5">FB & IG Reels</span>
                  </div>
                  <div className="bg-slate-950/80 p-2.5 rounded-xl border border-slate-800">
                    <span className="text-[10px] text-slate-400 block mb-0.5">Leads Form</span>
                    <span className="text-sm font-extrabold text-pink-400">188 Leads</span>
                    <span className="text-[9px] text-emerald-400 block mt-0.5">CPL ₹120</span>
                  </div>
                  <div className="bg-slate-950/80 p-2.5 rounded-xl border border-slate-800">
                    <span className="text-[10px] text-slate-400 block mb-0.5">Retargeting</span>
                    <span className="text-sm font-extrabold text-purple-400">Active</span>
                    <span className="text-[9px] text-slate-300 block mt-0.5">Custom Pixel</span>
                  </div>
                </div>

                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 flex items-center justify-between">
                  <div className="space-y-0.5">
                    <span className="text-[10px] text-slate-400 block">Active Campaign</span>
                    <span className="text-xs font-bold text-slate-200">Instagram Reels Lead Gen Funnel</span>
                  </div>
                  <span className="text-[10px] font-bold text-pink-400 bg-pink-500/10 px-2 py-1 rounded border border-pink-500/20">
                    Optimized
                  </span>
                </div>
              </div>
          ...
          {/* GOOGLE BUSINESS PROFILE VISUALIZER */}
          {slug === 'google-business-profile-management' && (
            <motion.div 
              ...
              className="space-y-3"
            >
              <div className="bg-white border border-brand-border rounded-2xl overflow-hidden shadow-xl p-4 space-y-3">
                <div className="flex justify-between items-center border-b border-slate-100 pb-2.5">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
                    <span className="text-xs font-bold text-brand-text">GOOGLE MAPS LOCAL 3-PACK</span>
                  </div>
                  <span className="text-[10px] bg-emerald-50 text-emerald-700 px-2.5 py-0.5 rounded-full border border-emerald-200 font-extrabold">
                    RANK #1 LOCAL
                  </span>
                </div>
                ...
                <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 space-y-2">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="text-xs font-extrabold text-brand-text">MakeMyPages Digital Agency</h4>
                      <div className="flex items-center gap-1 mt-0.5">
                        <span className="text-amber-500 text-xs font-bold">5.0 ★★★★★</span>
                        <span className="text-[10px] text-slate-500">(120+ Verified Reviews)</span>
                      </div>
                    </div>
                    <span className="text-[10px] font-bold bg-sky-100 text-sky-800 px-2 py-0.5 rounded">Verified ✓</span>
                  </div>

                  <div className="grid grid-cols-3 gap-2 pt-1 border-t border-slate-200/60 text-center">
                    <div className="bg-white p-2 rounded-lg border border-slate-200">
                      <span className="text-[9px] text-slate-500 block">Phone Calls</span>
                      <span className="text-xs font-extrabold text-emerald-600">+142 Calls</span>
                    </div>
                    <div className="bg-white p-2 rounded-lg border border-slate-200">
                      <span className="text-[9px] text-slate-500 block">Map Views</span>
                      <span className="text-xs font-extrabold text-brand-primary">12.4K</span>
                    </div>
                    <div className="bg-white p-2 rounded-lg border border-slate-200">
                      <span className="text-[9px] text-slate-500 block">Direction Clicks</span>
                      <span className="text-xs font-extrabold text-purple-600">89 Clicks</span>
                    </div>
                  </div>
                </div>
              </div>
